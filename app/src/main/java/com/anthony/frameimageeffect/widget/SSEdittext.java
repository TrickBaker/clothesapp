...
/**
 * Created by Jerry  on 24/02/2016.
 */
public class SSEdittext extends AppCompatEditText {
    ...
    public void init(Context ctx, AttributeSet attrs) {
        ...
        String font = null;
        if (attrs != null) {
            TypedArray typedArray = ctx.obtainStyledAttributes(attrs, R.styleable.SSEdittext);
            font = typedArray.getString(R.styleable.SSEdittext_fontEt);
            typedArray.recycle();
        }
    ...
    public void setFont(Context ctx, String font) {
        try {
            ...
            Log.v(SSEdittext.class.getName(), ex.toString());
        }
    }
