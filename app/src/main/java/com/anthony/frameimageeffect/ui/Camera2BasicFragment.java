...
import com.anthony.frameimageeffect.util.AutoFitTextureView;
...
public class Camera2BasicFragment extends BaseFragment
    ...
    public static Camera2BasicFragment newInstance(Bundle bundle) {
    ...
    public static byte[] getImageByteArray() {
        if(imageSaver != null) {
            return imageSaver.getByteArray();
        }
        return null;
    }
    ...
    public int getLayoutId() {
        return R.layout.include_image_view;
    }
    ...
    {
        return imageSaver.getImageHeight();
    }

    public static int getImageWidth()
    {
        return imageSaver.getImageWidth();
    }
    ...
    @OnClick({R.id.btnCapture, R.id.btnStop})
